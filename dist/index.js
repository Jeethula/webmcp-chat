...
import { GoogleGenAI as de, mcpToTool as ue } from "@google/genai";
...
function pe() {
  ...
  return A.Fragment = c, A.jsx = u, A.jsxs = u, A;
}
var M = {};
var H;
function be() {
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
      ...
      if (a = null, o !== void 0 && (u(o), a = "" + o), m(t) && (u(t.key), a = "" + t.key), "key" in t) {
        o = {};
        for (var D in t)
          D !== "key" && (o[D] = t[D]);
      } else o = t;
...
function ke({
  ...
  const { client: s } = me(), [m, p] = P(g), [E, _] = P(!1), [w, b] = P(null), f = V(() => n ? new de({ apiKey: n }) : null, [n]), h = B(
    async (v) => {
      const k = v?.trim();
      if (!k) return;
      if (!n) {
...
function Ee({
  ...
  placeholder: u = "Ask the assistant to read or update app state...",
  ...
  return /* @__PURE__ */ r.jsxs("section", { className: `webmcp-card ${n}`.trim(), children: [
    ...
    /* @__PURE__ */ r.jsxs("div", { className: "webmcp-messages", children: [
      ...
      w.map((d) => /* @__PURE__ */ r.jsx("div", { className: "webmcp-message-row", children: /* @__PURE__ */ r.jsx(
        "div",
        {
